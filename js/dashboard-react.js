    ...
    return h('div', {
      ...
      h('div', {
        ...
        h(KPICard, {
          ...
          value: summary ? summary.total_tickets_today : 0,
        ...
        h(KPICard, {
          ...
          value: summary ? summary.ai_resolution_rate : 0,
          suffix: '%',
          decimals: 1,
          trendBadge: 'SLA Target > 80%',
          trendText: 'Zero-human touch rate',
          trendPositive: true,
          icon: ICONS.ai,
          iconColor: '#10b981',
        ...
        h(KPICard, {
          ...
          value: (summary && summary.avg_resolution_time != null) ? summary.avg_resolution_time : 1.2,
          suffix: ' hrs',
          decimals: 1,
          trendBadge: '-18% MTTR',
          trendText: 'Mean time to resolution',
          trendPositive: true,
          icon: ICONS.time,
          iconColor: '#f97316',
